...
import db.pojo.Impl.ExerciseImpl;
        ...
        while (true) {
            try {
                ...
                if (insertType == NEW) {
                    ...
                    preparedStatement.setLong(1, exercise.getExerciseId());
                    preparedStatement.setLong(2, exercise.getTrainingId());
                    ...
                    preparedStatement.setLong(2, exercise.getExerciseId());
                    preparedStatement.setLong(3, exercise.getTrainingId());
