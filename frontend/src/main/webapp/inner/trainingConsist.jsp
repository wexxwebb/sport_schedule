...
<head>
    ...
    <!-- Bootstrap -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/style/jQuery/jquery-ui.css">
                    ...
                    <c:forEach var="exercise" items="${exerciseList}">
                        <tr>
                            ...
                            <td style="text-align: right;">
                                <span style="cursor: pointer; font-size: 20px; color: red;"
                                      class="glyphicon glyphicon-remove"
                                      aria-hidden="true" onclick="del(${exercise.id})"></span>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
                ...
                <table style="display: inline-block" class="table table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input type="text" name="weight" onclick="this.select()"
                            ...
                            <td style="text-align: right;">
                                <span style="cursor: pointer; font-size: 20px;
                                      ...
                                      class="glyphicon glyphicon-plus" onclick="addExcercise()">
                                </span>
                            </td>
                        </tr>
                    </tbody>
...
<script src="${pageContext.request.contextPath}/style/jQuery/jquery.min.js"></script>
...
<script src="${pageContext.request.contextPath}/style/jQuery/jquery-ui.js"></script>
...
<script>
    function del(exerciseId) {
        $.ajax({
            url: "${pageContext.request.contextPath}/inner/delExercise",
            method: "POST",
            data: {id: exerciseId},
    ...
    function addExcercise() {
        $.ajax({
            url: "${pageContext.request.contextPath}/inner/addExercise",
            method: "POST",
            data: {
            ...
            success: function (result) {
                //{"id":16,"exerciseId":25,"exercise":{"id":25,"name":"Гиперэкстензия"},"trainingId":1,"approach":3,"repetition":10,"weight":10}
                var tbody = document.getElementById("exercise");
                ...
                name.innerHTML = String(exercise.exerciseDataName);
                ...
                weight.innerHTML = String(exercise.weight);
